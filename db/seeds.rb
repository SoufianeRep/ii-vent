...
kyles_task_one = Task.create!(name: 'Sound check', description: 'Perform soundcheck before doors open', category: 'music', event: kyles_event_one, start: DateTime.now, end: kyles_event_one.end_date)
kyles_task_two = Task.create!(name: 'Post to socials', description: 'Make social media posts promoting the event', category: 'music', event: kyles_event_two, start: DateTime.now, end: kyles_event_two.end_date)
...
kyles_task_four = Task.create!(name: 'Kanpai', description: 'Pre-event meeting and kanpai!', category: 'music', event: kyles_event_three, start: DateTime.now, end: kyles_event_three.end_date)
